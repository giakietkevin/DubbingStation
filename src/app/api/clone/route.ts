  ...
  try {
    ...
    const formattedVoices = user.customVoices.map((voice) => {
      ...
      return {
        ...
        f0MedianHz: meta?.acousticProfile?.f0MedianHz || meta?.f0MedianHz,
        pitchRegister: meta?.acousticProfile?.pitchRegister,
        warmth: meta?.acousticProfile?.warmth,
        brightness: meta?.acousticProfile?.brightness,
        optimalBaseVoiceName: meta?.acousticProfile?.optimalBaseVoiceName,
        formantF1: meta?.acousticProfile?.formantF1,
        formantF2: meta?.acousticProfile?.formantF2,
        formantF3: meta?.acousticProfile?.formantF3,
        formantF4: meta?.acousticProfile?.formantF4,
        vocalTractLengthCm: meta?.acousticProfile?.vocalTractLengthCm,
      };
    });
  ...
  try {
    ...
    return NextResponse.json({
      ...
      voice: {
        ...
        f0MedianHz: metadata.acousticProfile?.f0MedianHz || metadata.f0MedianHz,
        pitchRegister: metadata.acousticProfile?.pitchRegister,
        warmth: metadata.acousticProfile?.warmth,
        brightness: metadata.acousticProfile?.brightness,
        optimalBaseVoiceName: metadata.acousticProfile?.optimalBaseVoiceName,
        formantF1: metadata.acousticProfile?.formantF1,
        formantF2: metadata.acousticProfile?.formantF2,
        formantF3: metadata.acousticProfile?.formantF3,
        formantF4: metadata.acousticProfile?.formantF4,
        vocalTractLengthCm: metadata.acousticProfile?.vocalTractLengthCm,
      },
